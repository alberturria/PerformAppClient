    ...
    return (
        <div className="main-pane">
            ...
            <div className="informative-main-pane-message">
                <p>Esta aplicación web está destinada a la visualización de una manera sencilla de la información que podemos obtener de la medición de señales a través de la electromiografía.</p>
